...
import hypervisor from './images/hypervisor.png';
...
export const meta = {
  ...
  company: 'Corellium',
  description:
    'Working with the newly formed frontend team on a range of greenfield projects while also evolving and maintaining the existing core app.',
...
After a review of hundreds of files I found that we were using 35 shades of gray (almost 50). Colours were in a similar state with no particular pattern to the steps or application.
