...
export const Button: FC<ButtonProps> = ({ className, href, ...props }) => {
  ...
  className = clsx(
    ...
    'ring-1 ring-neutral-300 text-neutral-800 hover:ring-neutral-400 active:ring-neutral-400 dark:ring-neutral-800 dark:text-neutral-300 dark:hover:ring-neutral-700 dark:active:ring-neutral-700',
